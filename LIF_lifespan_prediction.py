...
for x in ages:
    ...
    with model:
        ...
        ens = nengo.Ensemble(label="Prior", n_neurons=1000, dimensions=space.n_basis,
        ...
        ens2 = nengo.Ensemble(label="Likelihood", n_neurons=1000, dimensions=lik_space.n_basis,
        ...
        post = nengo.Ensemble(label="Posterior", n_neurons=1000, dimensions=post_space.n_basis,
                                 encoders=post_space.project(post_space_raw),
                                 eval_points=post_space.project(post_space_raw),
                                 neuron_type = nengo.Direct())
        product = nengo.networks.Product(n_neurons=500*2, dimensions=post_space.n_basis, input_magnitude=1)
        ...
        norm_post = nengo.Ensemble(label="Normalized Posterior", n_neurons=4000, dimensions=dim, 
